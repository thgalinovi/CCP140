        ...
        switch (second_option_integer) {
          ...
          case 2 -> {
            ...
            if (third_option.equals("N") || third_option.equals("n")) {
              ...
              smarttv tv = new smarttv(true, channel_number_integer);
            } else {
              System.out.println("# Invalid option.! ");
              break;
            }
          ...
          case 3 -> {
            ...
            if (third_option.equals("N") || third_option.equals("n")) {
              ...
              lamp.setBrightness(brightness_number_integer);
            } else {
              System.out.println("# Invalid option.!");
              break;
            }
          ...
          case 4 -> {
            ...
            if (third_option.equals("N") || third_option.equals("n")) {
              ...
              smartsound sound = new smartsound(true, volume_number_integer);
            } else {
              System.out.println("# Invalid option.!");
              break;
            }
